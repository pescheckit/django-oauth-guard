...
class ConfigurationTestCase(TestCase):
    ...
    def test_default_config(self):
        ...
        self.assertEqual(self.middleware.VALIDATION_PROBABILITY, 1.0)  # For tests we set to 1.0 
        self.assertEqual(self.middleware.VALIDATION_INTERVAL, 0)  # For tests we set to 0
